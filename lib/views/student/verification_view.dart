  ...
  Future<void> _startVerification() async {
    try {
      ...
      double distance = Geolocator.distanceBetween(
        ...
        widget.session.lat, widget.session.lng
      );
      ...
      final XFile? photo = await ImagePicker().pickImage(source: ImageSource.camera, preferredCameraDevice: CameraDevice.front);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (!_isLoading) Icon(_success ? Icons.check_circle : Icons.error, size: 80, color: _success ? Colors.green : Colors.red),
